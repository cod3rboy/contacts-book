...
func (uc *UserCreate) SetEmailID(s string) *UserCreate {
	uc.mutation.SetEmailID(s)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.EmailID(); !ok {
		return &ValidationError{Name: "email_id", err: errors.New(`ent: missing required field "User.email_id"`)}
	}
	if v, ok := uc.mutation.EmailID(); ok {
	...
	if _, ok := uc.mutation.MobileNumber(); !ok {
		return &ValidationError{Name: "mobile_number", err: errors.New(`ent: missing required field "User.mobile_number"`)}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.EmailID(); ok {
